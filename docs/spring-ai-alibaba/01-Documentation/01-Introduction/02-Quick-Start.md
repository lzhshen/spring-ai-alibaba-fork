...
- 其他模型提供商请 [参考文档](https://java2ai.com/integration/chatmodels/openai-chat)
...
注意: 在生产环境中，使用持久化的 CheckPointer 将数据保存到数据库。更多详情参见 [内存管理](https://java2ai.com/docs/frameworks/agent-framework/tutorials/memory/) 文档。
