...
McpNodeProperties [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java "查看完整源代码")
...
McpGaphConfiguration [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java "查看完整源代码")
...
McpClientToolCallbackProvider [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java "查看完整源代码")
...
McpNode [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java "查看完整源代码")
...
McpController [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/McpNodeExample.java "查看完整源代码")
...
启动本地 MCP Server，提供时间服务 ![](https://java2ai.com/assets/images/NivBbKqXooFsgexeeRrcIV0rnEf-1b3a91952df68336f781d55aa65d11c0.png)

调用接口，触发本地端 MCP Server 提供的时间服务 ![](https://java2ai.com/assets/images/LMPkbZ5heoHs2Qx604kcdiplnlc-c1289e5341e5e144b6eb718daae11f4c.png)