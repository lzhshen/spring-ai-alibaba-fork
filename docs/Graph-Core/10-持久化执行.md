...
3. 将任何非确定性操作（例如，随机数生成）或具有副作用的操作（例如，文件写入、API 调用）包装在节点中，以确保在恢复工作流时，这些操作不会在特定运行中重复，而是从持久化层检索它们的结果。有关更多信息，请参阅 [确定性和一致性重放](https://java2ai.com/docs/frameworks/graph-core/examples/#%E7%A1%AE%E5%AE%9A%E6%80%A7%E5%92%8C%E4%B8%80%E8%87%B4%E6%80%A7%E9%87%8D%E6%94%BE) 。
...
执行时配置 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/LongTimeRunningTaskExample.java "查看完整源代码")
...
原始版本 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/LongTimeRunningTaskExample.java "查看完整源代码")
...
改进版本 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/LongTimeRunningTaskExample.java "查看完整源代码")
...
- **暂停和恢复工作流** ：使用中断机制在特定点暂停工作流，并使用更新的状态恢复它。有关更多详细信息，请参阅 [人在回路中文档](https://java2ai.com/docs/frameworks/graph-core/examples/human-in-the-loop) 。
- **从失败中恢复** ：在异常后（例如，LLM 提供商中断）从最后一个成功的检查点自动恢复工作流。这涉及使用相同的线程标识符执行工作流。

### 从错误中恢复示例

从错误中恢复示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/LongTimeRunningTaskExample.java "查看完整源代码")
...
长时间运行的数据处理任务示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/LongTimeRunningTaskExample.java "查看完整源代码")
