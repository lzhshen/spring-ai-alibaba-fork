...
定义状态和状态键策略 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
读取和分类节点实现 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
搜索和跟踪节点实现 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
响应节点实现 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
创建邮件处理 Graph [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
测试邮件代理 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/QuickStartExample.java "查看完整源代码")
...
- [子图作为 NodeAction](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-nodeaction)
- [子图作为 StateGraph](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-stategraph)
- [子图作为 CompiledGraph](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-compiledgraph)
...
- [持久化](https://java2ai.com/docs/frameworks/graph-core/examples/persistence)
- [时光旅行](https://java2ai.com/docs/frameworks/graph-core/examples/time-travel)
