...
定义子图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
直接嵌入子图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
使用编译后的子图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
状态隔离 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
递归子图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
完整示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsStateGraphExample.java "查看完整源代码")
...
![png](https://java2ai.com/assets/images/subgraph-as-stategraph_15_0-75766007901496c1037864c1d7071827.png)

![png](https://java2ai.com/assets/images/subgraph-as-stategraph_17_0-b4735120707fadb2d15a765fa74efc88.png)

## 相关文档

- [子图作为 NodeAction](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-nodeaction) - 另一种集成方式
- [子图作为 CompiledGraph](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-compiledgraph) - 编译后使用
- [快速入门](https://java2ai.com/docs/frameworks/graph-core/quick-start) - Graph 基础