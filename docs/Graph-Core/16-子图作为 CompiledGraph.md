...
创建并编译子图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
在节点中使用 CompiledGraph [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
在父图中使用 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
多个子图复用 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
并行执行多个 CompiledGraph [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
预编译策略 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
完整示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java "查看完整源代码")
...
![png](https://java2ai.com/assets/images/subgraph-as-compiledgraph_15_0-75766007901496c1037864c1d7071827.png)

![png](https://java2ai.com/assets/images/subgraph-as-compiledgraph_17_0-e3b23b28db9f86555848a1408d7cf1f1.png)

## 相关文档

- [子图作为 NodeAction](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-nodeaction) - 节点包装方式
- [子图作为 StateGraph](https://java2ai.com/docs/frameworks/graph-core/examples/subgraph-as-stategraph) - 直接嵌入方式
