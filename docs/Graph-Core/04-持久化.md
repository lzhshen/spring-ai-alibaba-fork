---
title: "持久化"
source: "https://java2ai.com/docs/frameworks/graph-core/core/persistence/"
author:
...
指定 threadId [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
检查点示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
当与保存的图状态交互时，您 **必须** 指定一个 [会话标识符](https://java2ai.com/docs/frameworks/graph-core/core/persistence/#%E4%BC%9A%E8%AF%9Dthreads) 。您可以通过调用 `graph.getState(config)` 来查看图的 *最新* 状态。这将返回一个 `StateSnapshot` 对象，该对象对应于与配置中提供的会话 ID 关联的最新检查点，或者如果提供了检查点 ID，则对应于该会话的检查点。

获取状态 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
获取状态历史 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
重放图执行 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
更新状态 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
定义状态策略 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
更新状态示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/PersistenceExample.java "查看完整源代码")
...
PostgreSQL 数据库检查点器，详见 [PostgreSQL 检查点持久化](https://java2ai.com/docs/frameworks/graph-core/examples/checkpoint-redis) 。
