---
title: "核心概念"
source: "https://java2ai.com/docs/frameworks/graph-core/core/core-library/#schema"
author:
...
1. [State](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#state%E7%8A%B6%E6%80%81) ：共享的数据结构，表示应用程序的当前快照。它由 `OverAllState` 对象表示。
2. [Nodes](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#%E8%8A%82%E7%82%B9nodes) ：一个 **函数式接口** (`AsyncNodeAction`)，编码智能体的逻辑。它们接收当前的 `State` 作为输入，执行一些计算或副作用，并返回更新后的 `State` 。或者使用 `AsyncNodeActionWithConfig` ，它可以额外接收 `RunnableConfig` 用于传递上下文。
3. [Edges](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#%E8%BE%B9edges) ：一个 **函数式接口** (`AsyncEdgeAction`)，根据当前的 `State` 确定接下来执行哪个 `Node` 。它们可以是条件分支或固定转换。或者使用 `AsyncEdgeActionWithConfig` ，它可以额外接收 `RunnableConfig` 用于传递上下文。
...
要构建您的图，首先定义 [state](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#state%E7%8A%B6%E6%80%81) ，然后添加 [nodes](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#%E8%8A%82%E7%82%B9nodes) 和 [edges](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#%E8%BE%B9edges) ，最后编译它。编译图是什么意思？为什么需要编译？
...
编译图 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
创建 KeyStrategyFactory [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
ReplaceStrategy 示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
AppendStrategy 示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
RemoveByHash 使用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
- 一个 **函数式接口** (\[AsyncNodeAction\])，其入参是 [OverAllState](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#state) ，您可以使用 \[addNode\] 方法将这些节点添加到图中。
- 一个 **函数式接口** (\[AsyncNodeActionWithConfig\])，其入参是 [OverAllState](https://java2ai.com/docs/frameworks/graph-core/core/core-library/#state) 和 RunnableConfig，您可以使用 \[addNode\] 方法将这些节点添加到图中。
...
添加条件边 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
...
使用会话 ID [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/CoreLibraryExample.java "查看完整源代码")
