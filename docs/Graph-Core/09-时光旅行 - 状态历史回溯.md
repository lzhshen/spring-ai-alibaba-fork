...
- [持久化](https://java2ai.com/docs/frameworks/graph-core/examples/persistence) - 状态持久化
- [等待用户输入](https://java2ai.com/docs/frameworks/graph-core/examples/human-in-the-loop) - 中断和恢复
- [Checkpoint 机制](https://java2ai.com/docs/frameworks/graph-core/examples/checkpoint-redis) - 检查点详解
