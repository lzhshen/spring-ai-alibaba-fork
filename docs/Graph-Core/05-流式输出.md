---
title: "流式输出"
source: "https://java2ai.com/docs/frameworks/graph-core/core/streaming/"
author:
...
流式节点实现 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/StreamingExample.java "查看完整源代码")
...
处理流式输出的节点 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/StreamingExample.java "查看完整源代码")
...
使用流式输出的完整示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/StreamingExample.java "查看完整源代码")
...
流输出数据类型层次 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/graph/core/StreamingExample.java "查看完整源代码")
...
如果你有多个并行节点（普通节点或者嵌套子图），可以参考 [并行节点的流式处理](https://java2ai.com/docs/frameworks/graph-core/examples/parallel-streaming) 来了解详情。
