许多 AI 应用程序需要记忆来跨多个交互共享上下文。在 Spring AI Alibaba 中，通过 [`Checkpointer`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/checkpoint/Checkpoint.java) 为任何 [`StateGraph`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/StateGraph.java) 提供记忆。

## 核心概念

在创建任何 Spring AI Alibaba 工作流时，可以通过以下方式设置持久化：

1. 创建一个 [`Checkpointer`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/checkpoint/Checkpoint.java) ，例如 [`MemorySaver`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/checkpoint/savers/MemorySaver.java)
2. 在编译图时通过 [`CompileConfig`](https://github.com/alibaba/spring-ai-alibaba/blob/main/spring-ai-alibaba-graph-core/src/main/java/com/alibaba/cloud/ai/graph/CompileConfig.java) 传递 Checkpointer
...
- [等待用户输入](https://java2ai.com/docs/frameworks/graph-core/examples/human-in-the-loop) - 中断和恢复示例
- [时光旅行](https://java2ai.com/docs/frameworks/graph-core/examples/time-travel) - 状态历史导航
