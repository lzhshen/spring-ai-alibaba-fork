...
![Spring AI Generic Model API](https://java2ai.com/assets/images/spring-ai-generic-model-api-2bb366b8599c94bec2f4b8d515d5c420.jpg)
...
Model 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
StreamingModel 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
ModelRequest 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
ModelOptions 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
ModelResponse 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
ModelResult 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
ChatModel 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
StreamingChatModel 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
Prompt 类定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
Message 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
MediaContent 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
![Spring AI Message API](https://java2ai.com/assets/images/spring-ai-message-api-28ea8b962394e036bab091f1d08e922c.jpg)
...
ChatOptions 接口定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
![Chat Options Flow](https://java2ai.com/assets/images/chat-options-flow-5e6c0610d00656988221f84a6cca2587.jpg) 这种设计符合 Spring 的模块化和可互换性理念，使开发人员能够轻松地使用不同的 AI model 并根据需要调整参数，所有这些都在 Spring AI 框架提供的统一接口内。

### ChatResponse

`ChatResponse` 类的结构如下：

ChatResponse 类定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
Generation 类定义 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
![Spring AI Chat Completions Clients](https://java2ai.com/assets/images/spring-ai-chat-completions-clients-c8a018fbb668533a6d75ee162e92e2d2.jpg)

### 支持的模型提供商

- **[OpenAI Chat Completion](https://java2ai.com/integration/chatmodels/openai-chat)** (支持流式、多模态和函数调用)
- **[Microsoft Azure OpenAI Chat Completion](https://java2ai.com/integration/chatmodels/more/azure-openai-chat)** (支持流式和函数调用)
- **[Alibaba DashScope Chat Completion](https://java2ai.com/integration/chatmodels/dashScope)** (支持流式和函数调用)
- **[Ollama Chat Completion](https://java2ai.com/integration/chatmodels/ollama-chat)** (支持流式、多模态和函数调用)
- **[Hugging Face Chat Completion](https://java2ai.com/integration/chatmodels/more/huggingface)** (不支持流式)
- **[Google Vertex AI Gemini Chat Completion](https://java2ai.com/integration/chatmodels/more/google-vertexai)** (支持流式、多模态和函数调用)
- **[Amazon Bedrock](https://java2ai.com/integration/chatmodels/more/bedrock-converse)**
- **[Mistral AI Chat Completion](https://java2ai.com/integration/chatmodels/more/mistralai-chat)** (支持流式和函数调用)
...
![Spring AI Chat API](https://java2ai.com/assets/images/spring-ai-chat-api-8d93962cde1527e1b8c098c68da84ef2.jpg)
...
创建 DashScopeChatModel [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
简单调用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
DashScopeChatOptions 配置示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
运行时覆盖选项示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
多轮对话示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
函数调用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ModelsExample.java "查看完整源代码")
...
详细的 Agent 使用方法请参考 [Agents 文档](https://java2ai.com/docs/frameworks/agent-framework/tutorials/agents) 。
