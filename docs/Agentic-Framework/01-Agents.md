...
![reactagent](https://java2ai.com/img/agent/agents/reactagent.png)
...
ReactAgent 基础配置示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
DashScopeChatModel 高级配置 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
SearchTool 自定义工具示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
ToolErrorInterceptor 工具错误处理 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
系统提示基础配置 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
DynamicPromptInterceptor 动态提示拦截器 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
Agent 基础调用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
PoemOutput 结构化输出示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
Memory 配置示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
Hook 使用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
Interceptor 使用示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
自定义停止条件 Hook [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/AgentsExample.java "查看完整源代码")
...
更多关于 Graph 底层流式输出机制，请参考 [Graph 流式输出](https://java2ai.com/docs/frameworks/graph-core/core/streaming) 。

## 下一步

- 学习 [多 Agent 编排](https://java2ai.com/docs/frameworks/agent-framework/advanced/multi-agent) 构建复杂系统
- 探索 [Graph API](https://java2ai.com/docs/frameworks/agent-framework/advanced/workflow) 实现自定义工作流
- 查看 [工具开发](https://java2ai.com/docs/frameworks/agent-framework/tutorials/tools) 扩展 Agent 能力
