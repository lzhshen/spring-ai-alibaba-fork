...
HumanInTheLoopHook 配置示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java "查看完整源代码")
...
响应中断示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java "查看完整源代码")
...
HumanInTheLoop 完整示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java "查看完整源代码")
...
HITLHelper 实用工具方法示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/HumanInTheLoopExample.java "查看完整源代码")
...
- [Hooks](https://java2ai.com/docs/frameworks/agent-framework/tutorials/hooks) - 了解 Hook 机制
- [Interceptors](https://java2ai.com/docs/frameworks/agent-framework/tutorials/hooks) - 了解 Interceptor 机制
- [Memory](https://java2ai.com/docs/frameworks/agent-framework/advanced/memory) - 检查点和持久化
