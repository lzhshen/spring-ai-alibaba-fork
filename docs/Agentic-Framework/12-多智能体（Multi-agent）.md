...
| 模式 | 工作原理 | 控制流 | 使用场景 |
| --- | --- | --- | --- |
| [**Tool Calling**](https://java2ai.com/docs/frameworks/agent-framework/advanced/#tool-calling) | [Supervisor Agent将其他Agent作为 *工具* 调用](https://java2ai.com/docs/frameworks/agent-framework/advanced/agent-tool) 。"工具"Agent不直接与用户对话——它们只执行任务并返回结果。 | 集中式：所有路由都通过调用Agent。 | 任务编排、结构化工作流。 |
| [**Handoffs**](https://java2ai.com/docs/frameworks/agent-framework/advanced/#Handoffs) | 当前的Agent决定将控制权转移给另一个Agent。活动Agent随之变更，用户可以继续与新的Agent直接交互。 | 去中心化：Agent可以改变当前由谁来担当活跃Agent。 | 跨领域对话、专家接管。 |
...
关于工具调用模式的使用请查看 [Agent Tool 文档](https://java2ai.com/docs/frameworks/agent-framework/advanced/agent-tool) 。
...
![Spring AI Alibaba SequentialAgent](https://java2ai.com/assets/images/sequential-e74d29f091f1c9485bd3bad3f70b7ffd.png)

#### 实现

SequentialAgent 实现示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
控制推理内容示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
![Spring AI Alibaba ParallelAgent](https://java2ai.com/assets/images/parallel-e7a5e533a4de5239ecdb7a689e04a510.png)

#### 实现

ParallelAgent 实现示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
自定义合并策略完整示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
![Spring AI Alibaba LlmRoutingAgent](https://java2ai.com/assets/images/routing-eb48b056a3007ac83de36c686ad82905.png)

#### 实现

LlmRoutingAgent 实现示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
优化路由准确性示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
![Spring AI Alibaba SupervisorAgent](https://java2ai.com/assets/images/supervisor-836e571c08d56945f6f380e41fd3c00a.png)

#### 实现

SupervisorAgent 基础示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/spring-ai-alibaba-agent-framework/src/test/java/com/alibaba/cloud/ai/graph/agent/SupervisorAgentTest.java "查看完整源代码")
...
SupervisorAgent 自定义系统提示示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/spring-ai-alibaba-agent-framework/src/test/java/com/alibaba/cloud/ai/graph/agent/SupervisorAgentTest.java "查看完整源代码")
...
SupervisorAgent 使用占位符示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/spring-ai-alibaba-agent-framework/src/test/java/com/alibaba/cloud/ai/graph/agent/SupervisorAgentTest.java "查看完整源代码")
...
FlowAgent 架构示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
实现自定义FlowAgent示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
使用自定义Agent示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
循环Agent实现示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
...
混合模式示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/MultiAgentExample.java "查看完整源代码")
