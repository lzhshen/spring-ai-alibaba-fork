...
> **TIP:** 迁移与更多 Tool Calling 说明请参考： [Tool Calling 使用指南](https://java2ai.com/integration/toolcalls/tool-calls) 。
...
DateTimeTools 信息检索示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
DateTimeTools 执行操作示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
使用多个工具示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
@Tool 注解示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
- `returnDirect` ：tool 结果是否应直接返回给客户端或传递回 model。有关更多详细信息，请参阅 [返回直接](https://java2ai.com/docs/frameworks/agent-framework/tutorials/#%E8%BF%94%E5%9B%9E%E7%9B%B4%E6%8E%A5) 。
- `resultConverter` ：用于将 tool call 的结果转换为 `String object` 以发送回 AI model 的 `ToolCallResultConverter` 实现。有关更多详细信息，请参阅 [结果转换](https://java2ai.com/docs/frameworks/agent-framework/tutorials/#%E7%BB%93%E6%9E%9C%E8%BD%AC%E6%8D%A2) 。
...
> **NOTE:** 某些类型不受支持。有关更多详细信息，请参阅 [方法 Tool 限制](https://java2ai.com/docs/frameworks/agent-framework/tutorials/#%E6%96%B9%E6%B3%95-tool-%E9%99%90%E5%88%B6) 。
...
除了 `@ToolParam` 注解外，您还可以使用来自 Swagger 的 `@Schema` 注解或来自 Jackson 的 `@JsonProperty` 。有关更多详细信息，请参阅 [JSON Schema](https://java2ai.com/docs/frameworks/agent-framework/tutorials/#json-schema) 。

#### 编程式规范：MethodToolCallback

您可以通过编程方式构建 `MethodToolCallback` 来将方法转换为 tool。

MethodToolCallback 示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
静态方法示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
函数类型使用基于函数的 tool 规范方法支持。有关更多详细信息，请参阅 [函数作为 Tools](https://java2ai.com/docs/frameworks/agent-framework/tutorials/#%E5%87%BD%E6%95%B0%E4%BD%9C%E4%B8%BA-tools) 。
...
WeatherService 工具定义示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
FunctionToolCallback 构建示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
使用常量定义工具名称示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
使用动态规范添加工具到 ChatClient [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
使用动态规范添加默认工具到 ChatClient [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
ToolCallback 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
ToolDefinition 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
可选参数示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
ToolCallResultConverter 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义结果转换器示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
returnDirect 示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
ToolCallingManager 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义 ToolCallingManager [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
![框架控制的 tool 执行生命周期](https://java2ai.com/assets/images/framework-manager-cfd08dbb88e80ba23e30aa1dc125a58b.jpg)
...
ToolExecutionExceptionProcessor 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义异常处理器 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
ToolCallbackResolver 接口 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义 ToolCallbackResolver [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义工具名称示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
自定义工具描述示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
...
组合使用多种工具提供方式 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/tutorials/ToolsExample.java "查看完整源代码")
