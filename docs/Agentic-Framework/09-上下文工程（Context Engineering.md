...
![reactagent](https://java2ai.com/assets/images/reactagent-62b03d114223a5a926dbc975846eb405.png)
...
| 上下文类型 | 你控制的内容 | 瞬态或持久 |
| --- | --- | --- |
| **[模型上下文](https://java2ai.com/docs/frameworks/agent-framework/advanced/#model-context)** | 模型调用中包含什么（指令、消息历史、工具、响应格式） | 瞬态 |
| **[工具上下文](https://java2ai.com/docs/frameworks/agent-framework/advanced/#tool-context)** | 工具可以访问和产生什么（对状态、存储、运行时上下文的读/写） | 持久 |
| **[生命周期上下文](https://java2ai.com/docs/frameworks/agent-framework/advanced/#lifecycle-context)** | 模型和工具调用之间发生什么（摘要、防护栏、日志等） | 持久 |
...
基于状态的动态提示示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
基于存储的个性化提示示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
MessageFilterInterceptor 消息过滤示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
ContextualToolInterceptor 基于上下文的工具选择示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
DynamicModelInterceptor 动态模型选择示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
响应格式控制示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
StatefulTool 工具中访问状态示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
StateModifyingTool 工具修改状态示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
LoggingHook 自定义Hook示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
...
SummarizationHook 消息摘要Hook示例 [查看完整代码](https://github.com/alibaba/spring-ai-alibaba/tree/main/examples/documentation/src/main/java/com/alibaba/cloud/ai/examples/documentation/framework/advanced/ContextEngineeringExample.java "查看完整源代码")
